  ...
  return (
    ...
    <div className="App">
      <header className="App-header">
        <h1 className='h-100 w-100'><b>Render Weather App</b></h1>
        ...
        {typeof weather.main !== "undefined" ? (
          <div>
            {/*Città*/}
            <p className='mt-3'> <b>{weather.name}</b>, {weather.main.temp} °C</p>

            {/*Temperatura*/}
            <p> <b>Max:</b> {weather.main.temp_max} °C</p>
            <p> <b>Min:</b> {weather.main.temp_min} °C</p>
            ...
            {weather.weather[0].main === "Clear" ?
                ...
                (<p>Si consiglia di prendere su un ombrello.</p>) :
                (<p>Un giorno senza sorriso è un giorno perso.</p>)
            }
          </div>
        ) : (
          <div className='row mt-3'>
